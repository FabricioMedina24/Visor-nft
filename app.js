    ...
    loader.load(
        ...
        function (gltf) {
            ...
            if (lienzo && lienzo.material) {
                ...
                // --- FUNCIÓN DE ANIMACIÓN DE RESPLANDOR (INTENSIFICADO) ---
                function hacerTransicionMagica(nuevaTextura) {
                    ...
                    // Color de la magia desde el JSON
                    ...
                    function animarResplandor() {
                        ...
                        // INTENSIDAD AUMENTADA A 6.0 PARA CUBRIR EL CAMBIO
                        material.emissiveIntensity = curvaLuz * 6.0; 
